    ...
    <div className="fixed bottom-5 left-5 z-50 w-full max-w-sm rounded-lg bg-white p-6 shadow-2xl ring-1 ring-black ring-opacity-5">
      ...
      <div className="flex-1">
        ...
        <ul className="mt-2 space-y-1 text-sm text-gray-600">
          <li>
            <strong>Discounted Rate:</strong> $59.90/hr <span className="text-gray-500 line-through">$80</span>
          </li>
        </ul>
      ...
      <div className="mt-5 flex justify-end space-x-3">
        ...
        <Link href= "/packages" className="inline-flex items-center rounded-md bg-violet-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-violet-700 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:ring-offset-2">
            View Packages
        </Link>
      </div>
    </div>
